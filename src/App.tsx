...
function App() {
  ...
  return (
    <div className="dark:bg-gray-800">
      <div className="nav-edited">
        <Darkmode />
        <h1
          className="text-center font-black text-3xl text-gray-800 dark:text-gray-50"
      ...
      <section className="w-full px-4 pt-8 lg:px-0 lg:w-[820px] mx-auto mt-4">
      ...
      <footer className="py-4 mt-12">
        <p className="text-center text-gray-800 dark:text-gray-300 text-xs">
          ...
          by Pushpendra Kumar (PK) -{" "}
          <a
            href="https://github.com/PKSharma96"
            target="_blank"
